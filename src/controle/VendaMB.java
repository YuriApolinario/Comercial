...
public class VendaMB {
	...
	public void finalizarVenda() {
		...
		for (ItensVenda it : listaItensVenda) {
			...
			it.setValotTotal(it.getQuantidade()*it.getValorUnitario());
		...
		listaVendas = daoVenda.buscarTodos();
		System.out.println("tamanho da lista" + listaItensVenda.size());
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Venda realizada com sucesso", null));
